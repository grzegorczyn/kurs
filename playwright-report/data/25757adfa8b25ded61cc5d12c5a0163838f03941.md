...
Call log:
  ...
  - waiting for locator('#show_messages')
    3 × locator resolved to <span class="highlight" id="show_messages" data-testid="message-text">Przelew wykonany! Chuck Demobankowy - 150,00PLN -…</span>
      - unexpected value "Przelew wykonany! Chuck Demobankowy - 150,00PLN - pizza"
    11 × locator resolved to <span class="highlight" id="show_messages" data-testid="message-text">Brak wiadomości</span>
